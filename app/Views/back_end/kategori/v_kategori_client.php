...
<?php foreach ($kategori as $kat): ?>
  <div class="modal fade" id="edit<?= $kat->id_kategori ?>" tabindex="-1">
    <div class="modal-dialog">
      <div class="modal-content">
        <form method="POST" action="<?= base_url('kategori/editkategoriclient/' . $kat->id_kategori) ?>" class="needs-validation" novalidate>
          <?= csrf_field() ?>
          <div class="modal-header">
...
<?php foreach ($kategori as $kat): ?>
  <div class="modal fade" id="hapus<?= $kat->id_kategori ?>" tabindex="-1">
    <div class="modal-dialog">
      <div class="modal-content">
        <form method="POST" action="<?= base_url('kategori/hapuskategoriclient/' . $kat->id_kategori) ?>">
          <?= csrf_field() ?>
          <div class="modal-header">
