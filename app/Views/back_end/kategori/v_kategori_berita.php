...
<?php foreach ($kategori as $kat): ?>
  <div class="modal fade" id="edit<?= $kat->id_kategori ?>">
    <div class="modal-dialog">
      <div class="modal-content">
        <form method="POST" action="<?= base_url('kategori/editkategoriberita/' . $kat->id_kategori) ?>" class="needs-validation" novalidate>
          <?= csrf_field() ?>
          <div class="modal-header">
...
<?php foreach ($kategori as $kat): ?>
  <div class="modal fade" id="hapus<?= $kat->id_kategori ?>">
    <div class="modal-dialog">
      <div class="modal-content">
        <form method="POST" action="<?= base_url('kategori/hapuskategoriberita/' . $kat->id_kategori) ?>">
          <?= csrf_field() ?>
          <div class="modal-header">
